...
internal class DGCollection_iOS : CollectionView, IDGCollection
{
    ...
    private readonly LinearItemsLayout _layot;
    ...
    public DGCollection_iOS(DataGrid dataGrid)
    {
        ...
        ItemsLayout = _layot = new LinearItemsLayout(ItemsLayoutOrientation.Vertical)
        {
            ItemSpacing = dataGrid.BordersThickness,
        };
    }
